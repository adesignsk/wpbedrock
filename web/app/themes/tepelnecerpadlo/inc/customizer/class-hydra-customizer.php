...
if ( ! class_exists( 'hydra_Customizer' ) ) :
	...
	class hydra_Customizer {
		...
		public function customize_register( $wp_customize ) {
			...
			$wp_customize->add_section( 'hydra_moje' , array(
				'title'      			=> __( 'Homepage', 'hydra' ),
				'priority'   			=> 899,
			) );

			$wp_customize->add_setting( 'hydra_moje', array(
				'default'               => array( 'kategorie', 'oblubene', 'novinky', 'doporucujeme', 'zlava', 'najpredavanejsie', 'fantastickatrojka' ),
				'sanitize_callback' 	=> 'sanitize_multiple_checkbox',
				'transport'             => 'postMessage',
			) );

			$wp_customize->add_control( new Customize_Control_Checkbox_Multiple( $wp_customize, 'hydra_moje', array(
				'settings'				=> 'hydra_moje',
				'section'				=> 'hydra_moje',
				'label'					=> __( 'Položky na homepage', 'hydra' ),
				'description'           => __( 'Vyber čo chceš zobraziť.', 'hydra' ),
				'priority'				=> 2,
				'choices'				=> array(
					'kategorie'         => __( 'Kategórie', 'hydra' ),
					'oblubene'          => __( 'Obľúbené', 'hydra' ),
					'novinky'           => __( 'Novinky', 'hydra' ),
					'doporucujeme'      => __( 'Doporučujeme', 'hydra' ),
					'zlava'             => __( 'Zľava', 'hydra' ),
					'najpredavanejsie'  => __( 'Najpredávanejšie', 'hydra' ),
					'fantastickatrojka' => __( 'Tri fantastické knihy', 'hydra' ),
				)
			) ) );
