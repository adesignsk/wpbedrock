...
( function() {
	...
	jQuery( window ).load( function() {
		jQuery( '.hydra-handheld-footer-bar .search > a' ).click( function(e) {
	...
	jQuery( '.main-navigation, .secondary-navigation' ).find( 'a' ).on( 'focus.hydra blur.hydra', function() {
		jQuery( this ).parents().toggleClass( 'focus' );
	});

	// Add focus to cart dropdown
	jQuery( window ).load( function() {
		jQuery( '.site-header-cart' ).find( 'a' ).on( 'focus.hydra blur.hydra', function() {
			jQuery( this ).parents().toggleClass( 'focus' );
		});
	});
